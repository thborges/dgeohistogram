...
struct maxgain {
	...
	double oborder;
	double (*get_border_start)(const EnvelopeC e);
	int bestidx;
	int remaining;
};

double getMinX(const EnvelopeC e) {
	return e.MinX;
}
double getMinY(const EnvelopeC e) {
	return e.MinY;
}
double getMaxX(const EnvelopeC e) {
	return e.MaxX;
}
double getMaxY(const EnvelopeC e) {
	return e.MaxY;
}
...
void reinsert_items(rtree_node *n, rtree_root *root, GList **parents, const GEOSGeometryH g,
	const EnvelopeC gmbr, struct idis *distances, const int items_to_reinsert) {
...
void get_best_p_lazy_new(struct idis *shrink, struct idis *dt, struct idis *db, struct idis *dl, struct idis *dr, const EnvelopeC mbr, const int pmax, struct maxgain *m) {
	int ib = 0;
	int il = 0;
	int ir = 0;
	int it = 0;
	EnvelopeC newmbr = mbr;
...
void get_best_p_lazy(struct idis *distances, double oborder, double (*getfirst)(const EnvelopeC e), const EnvelopeC mbr, const int pmax, struct maxgain *m) {
...
void greedy_2bestb_reinsert_on_parent(rtree_node *n, rtree_root *root, GList **parents, const GEOSGeometryH g, const EnvelopeC gmbr) {
...
void greedy_2bestborder_reinsert_on_parent(rtree_node *n, rtree_root *root, GList **parents, const GEOSGeometryH g, const EnvelopeC gmbr) {
