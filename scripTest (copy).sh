...
./histComp 30 30 ../datasets/alertas.shp 126 130 ../datasets/hidrografia.shp ../datasets/test/alertahidro.shp
./histComp 30 30 ../datasets/alertas.shp 77 75 ../datasets/rodovia.shp ../datasets/test/alertrodovia.shp
./histComp 30 30 ../datasets/alertas.shp 30 30 ../datasets/municipios.shp ../datasets/test/alertmunicipio.shp
./histComp 30 30 ../datasets/alertas.shp 30 30 ../datasets/vegeta.shp ../datasets/test/alertvegeta.shp
./histComp 30 30 ../datasets/hidrografia.shp 30 30 ../datasets/rodovia.shp ../datasets/test/hidrorodovia.shp
./histComp 30 30 ../datasets/hidrografia.shp 30 30 ../datasets/municipios.shp ../datasets/test/hidromunicipio.shp
./histComp 30 30 ../datasets/hidrografia.shp 30 30 ../datasets/vegeta.shp ../datasets/test/hidrovegeta.shp
./histComp 30 30 ../datasets/rodovia.shp 30 30 ../datasets/municipios.shp ../datasets/test/rodoviamunicipio.shp
./histComp 30 30 ../datasets/rodovia.shp 30 30 ../datasets/vegeta.shp ../datasets/test/rodoviavegeta.shp
./histComp 30 30 ../datasets/municipios.shp 30 30 ../datasets/vegeta.shp ../datasets/test/municipiovegeta.shp

./histComp 30 30 ../datasets/Rivers.shp 30 30 ../datasets/Railroads.shp ../datasets/test/riosferrovias.shp
./histComp 30 30 ../datasets/Rivers.shp 30 30 ../datasets/hydroinland.shp ../datasets/test/rioshidroinland.shp
./histComp 30 30 ../datasets/Rivers.shp 30 30 ../datasets/elev-contour-l.shp ../datasets/test/rioscontorno.shp
./histComp 30 30 ../datasets/Rivers.shp 30 30 ../datasets/Crops.shp ../datasets/test/rioscultura.shp
./histComp 30 30 ../datasets/Railroads.shp 30 30 ../datasets/hydroinland.shp ../datasets/test/ferroviashydroinland.shp
./histComp 30 30 ../datasets/Railroads.shp 30 30 ../datasets/elev-contour-l.shp ../datasets/test/ferroviascontorno.shp
./histComp 30 30 ../datasets/Railroads.shp 30 30 ../datasets/Crops.shp ../datasets/test/ferroviascultura.shp
./histComp 30 30 ../datasets/hydroinland.shp 30 30 ../datasets/elev-contour-l.shp ../datasets/test/hydroinlandcontorno.shp
./histComp 30 30 ../datasets/hydroinland.shp 30 30 ../datasets/Crops.shp ../datasets/test/hydroinlandcultura.shp
./histComp 30 30 ../datasets/elev-contour-l.shp 30 30 ../datasets/Crops.shp ../datasets/test/contornocultura.shp
