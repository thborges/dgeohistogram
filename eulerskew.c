  ...
  g_list_foreach(item, listaEulerskew->bucketsList)
  {
    ...
    if (!edgeExists)
    {
      ...
      edgeh1->mbr = EdgeMbr;
       g_list_foreach(edgeGlist, listaEulerskew->EdgesList){
        ...
        if(ENVELOPE_CONTAINS(edgeAdded->mbr, edgeh1->mbr)){ //if para não adicionar arestas diferentes que estão na mesma posição e possuem o mesmo tamanho
            edgeAdded = true;
        } 
       }
       if(!edgeAdded){
    ...
    if (!edgeExists)
    {
      ...
      edgeh2->mbr = EdgeMbr;
       g_list_foreach(edgeGlist, listaEulerskew->EdgesList){
        eulerskew_edge *edgeAdded = (eulerskew_edge *)edgeGlist->data;
        if(ENVELOPE_CONTAINS(edgeAdded->mbr, edgeh2->mbr )){ //if para não adicionar arestas diferentes que estão na mesma posição e possuem o mesmo tamanho
            edgeAdded = true;
        } 
       }
       if(!edgeAdded){
    ...
    if (!edgeExists)
    {
      ...
      edgev1->mbr = EdgeMbr;
       ...
       g_list_foreach(edgeGlist, listaEulerskew->EdgesList){
        eulerskew_edge *edgeAdded = (eulerskew_edge *)edgeGlist->data;
        if(ENVELOPE_CONTAINS(edgeAdded->mbr, edgev1->mbr )){ //if para não adicionar arestas diferentes que estão na mesma posição e possuem o mesmo tamanho
            edgeAdded = true;
        } 
       }
       if(!edgeAdded){
    ...
    if (!edgeExists)
    {
      ...
      edgev2->mbr = EdgeMbr;
       g_list_foreach(edgeGlist, listaEulerskew->EdgesList){
        eulerskew_edge *edgeAdded = (eulerskew_edge *)edgeGlist->data;
        if(ENVELOPE_CONTAINS(edgeAdded->mbr, edgev2->mbr)){ //if para não adicionar arestas diferentes que estão na mesma posição e possuem o mesmo tamanho
            edgeAdded = true;
        } 
       }
       if(!edgeAdded){
